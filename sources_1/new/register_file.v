module register_file(clk,reset,read_reg1,read_reg2,write_reg,reg_write,write_data,data1,data2);
input clk;
input reset;
input reg_write;
input [4:0]read_reg1;
...
always@(posedge reset)
  begin 
    reg_memory[0] = 32'h0;
         ...
         always@(reset)
         begin 
           assign data1 = reg_memory[read_reg1];
           assign data2 = reg_memory[read_reg2];
           end
         
         always@(posedge clk)
         if(reg_write)
          begin 
            assign reg_memory[write_reg] = write_data;
            end
